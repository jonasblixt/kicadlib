...
row  = "<tr><th style='width:320px'>Designator</th>" + "<th>Qnty</th>"
row += "<th>Name</th>"
row += "<th>Description</th>"
row += "<th>Manufacturer</th>" + "<th>Part Number</th></tr>"
...
for group in grouped:
    ...
    row = "\n    "
    row += "<tr bgcolor="+color+"><td>" + refs +"</td><td>" + str(len(group))
    row += "</td><td>" + c.getValue() + "</td>"
    row += "<td>"+c.getDescription() + "</td>" 
    row += "<td>" + c.getField("Manufacturer") + "</td>"
    row += "<td>" + c.getField("Part Number") 
    row += "</td></tr>"
